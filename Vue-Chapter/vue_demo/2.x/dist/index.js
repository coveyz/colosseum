...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.default = void 0;\n\nvar _Dep = _interopRequireDefault(__webpack_require__(/*! ./Dep */ \"./src/modules/Dep.js\"));\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nclass Watcher {\n  constructor(vm, fn) {\n    this.$vm = vm;\n    this.$fn = fn;\n    this.get();\n  }\n\n  get() {\n    _Dep.default.target = this;\n    this.$fn.call(this);\n    _Dep.default.target = null;\n  }\n\n  update() {\n    this.get();\n  }\n\n}\n\nvar _default = Watcher;\nexports.default = _default;\n\n//# sourceURL=webpack:///./src/modules/Watcher.js?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.observe = void 0;\n\nconst Dep = __webpack_require__(/*! ./Dep */ \"./src/modules/Dep.js\");\n/**\n *\n * @param {Object} data\n */\n\n\nconst observe = data => {\n  if (typeof data !== 'object') return;\n  new Observer(data);\n};\n\nexports.observe = observe;\n\nclass Observer {\n  constructor(data) {\n    if (Array.isArray(data)) {\n      //todo\n      console.log('array=>', data);\n    } else {\n      this.walk(data);\n    }\n  }\n\n  walk(data) {\n    Object.keys(data).forEach(key => {\n      defineReactive(data, key, data[key]);\n    });\n  }\n\n}\n\nconst defineReactive = (data, key, val) => {\n  observe(val);\n  const dep = new Dep(); // console.log('deps=>?', dep, key);\n\n  Object.defineProperty(data, key, {\n    get() {\n      Dep.target && dep.addDep(Dep.target);\n      return val;\n    },\n\n    set(newVal) {\n      if (newVal !== val) {\n        val = newVal;\n        dep.notify();\n        observe(val);\n      }\n    }\n\n  });\n};\n\n//# sourceURL=webpack:///./src/modules/observe.js?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.default = void 0;\n\nconst proxy = (vm, data) => {\n  Object.keys(data).forEach(key => {\n    Object.defineProperty(vm, key, {\n      get() {\n        return vm['$data'][key];\n      },\n\n      set(newValue) {\n        vm['$data'][key] = newValue;\n      }\n\n    });\n  });\n};\n\nvar _default = proxy;\nexports.default = _default;\n\n//# sourceURL=webpack:///./src/modules/proxy.js?");
